...
<div class="smugmugpanel">
    ...
    <div style="float: left;">
        <div class="icon">
            <a href="index.php?option=com_cedyahooweather&view=liveupdate"
               title="<?php echo JText::_('Live Update');?>"> <img
                    src="<?php echo JURI::root() ?>/media/com_cedyahooweather/images/update_48x48.png"
    ...
    <div style="float: left;">
        <div class="icon"><a href="https://www.galaxiis.com/ticket/" target="_blank"
                ...
                src="<?php echo JURI::root() ?>/media/com_cedyahooweather/images/bug.png"/>
            <span><?php echo JText::_('BUG?');?></span></a>
        </div>
    </div>

    <div style="float: left;">
        <div class="icon"><a href="https://www.galaxiis.com/cedyahooweather-showcase/" target="_blank"
                             title="<?php echo JText::_('HOME PAGE');?>"> <img
            src="<?php echo JURI::root() ?>/media/com_cedyahooweather/images/frontpage.png"/>
            <span><?php echo JText::_('HOME PAGE');?></span></a>
        </div>
    </div>
    <div style="float: left;">
        <div class="icon"><a
            href="https://www.galaxiis.com/cedyahooweather-doc/"
            target="_blank"
            title="<?php echo JText::_('MANUAL');?>"> <img
            src="<?php echo JURI::root() ?>/media/com_cedyahooweather/images/manual.png"/>
    ...
    <div style="float: left;">
        <div class="icon"><a
            ...
            src="<?php echo JURI::root() ?>/media/com_cedyahooweather/images/forum.png"/>
    ...
    <div style="float: left;">
        <div class="icon"><a
            ...
            src="<?php echo JURI::root() ?>/media/com_cedyahooweather/images/license.png"/>
        ...
        <div class="icon">
            <a href="skype:cedric.walter?call"
               title="<?php echo JText::_('SKYPE ME');?>"> <img
                src="<?php echo JURI::root() ?>/media/com_cedyahooweather/images/skype.png"/>
        ...
        <div class="icon">
            <a href="http://extensions.joomla.org/extensions/social-web/social-media/video-channels/20873"
               ...
               title="<?php echo JText::_('JED VOTE');?>"> <img
                src="<?php echo JURI::root() ?>/media/com_cedyahooweather/images/jed.png"/>
    ...
    <div style="float: left;">
        <div class="icon">
            <a href="https://www.galaxiis.com/cedyahooweather-download/"
               target="_blank"
               title="<?php echo JText::_('Download Latest Version');?>"> <img
                src="<?php echo JURI::root() ?>/media/com_cedyahooweather/images/download.png"/>
        ...
        <div class="icon">
            <a href="https://www.facebook.com/galaxiiscom"
               ...
               title="<?php echo JText::_('Like on Facebook');?>"> <img
                src="<?php echo JURI::root() ?>/media/com_cedyahooweather/images/facebook.png"/>
        ...
        <div class="icon">
            <a href="https://twitter.com/galaxiiscom"
               ...
               title="<?php echo JText::_('Follow Me on Twitter');?>"> <img
                src="<?php echo JURI::root() ?>/media/com_cedyahooweather/images/twitter.png"/>
        ...
        <div class="icon">
            <a href="https://plus.google.com/u/0/104558366166000378462"
               ...
               title="<?php echo JText::_('Follow Me on Google+');?>"> <img
                src="<?php echo JURI::root() ?>/media/com_cedyahooweather/images/google.png"/>
...
<div class="tagversion">
    ...
    <p><a href="http://extensions.joomla.org/extensions/social-web/social-media/video-channels/20873" target="_blank">CedYahooWeather 1.4.2</a>
    </p>
